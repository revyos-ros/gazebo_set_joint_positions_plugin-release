...
Name:           ros-humble-gazebo-set-joint-positions-plugin
Version:        1.0.3
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS gazebo_set_joint_positions_plugin package
...
BuildRequires:  ros-humble-joint-state-publisher
...
%changelog
* Wed Apr 03 2024 Boeing <Jason.Cochrane@boeing.com> - 1.0.3-1
